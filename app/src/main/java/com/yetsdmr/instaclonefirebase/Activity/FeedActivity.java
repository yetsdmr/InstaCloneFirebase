package com.yetsdmr.instaclonefirebase.Activity;
...
import com.yetsdmr.instaclonefirebase.Adapter.FeedRecyclerAdapter;
import com.yetsdmr.instaclonefirebase.R;
...
public class FeedActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.add_post){
            ...
            Intent intentToSingUp = new Intent(FeedActivity.this,SingUpActivity.class);
